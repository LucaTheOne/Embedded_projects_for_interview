...
const int gate_pin = 4;//pin cui è collegato il telecomando del cancellone
...
byte gate_command_code[] = {07, bf, 65, cf, 7f, 66, db};
...
void handleNewMessages(int numNewMessages)
{
  ...
  for (int i = 0; i < numNewMessages; i++){
    ...
    {   
      if(text == "/apri_cancello_mazzucchetti"){
        open_gate(chat_id);
...
void setup()
{
  ...
  attachInterrupt(BUTTON_PIN,open_gate,FALLING);
